...
const TagThumbnail: React.FC<TagThumbnailProps> = ({tag}) => {
    ...
    return (<div className="tag-thumbnail my-4">
        ...
        <div className="d-flex justify-content-between third-row px-3 py-2">
            <h5 className="retina-text-title">{tag.name}</h5>
            <div className="d-flex align-items-center">
                ...
                <span className="retina-text-light-gray m-0">{tag.images.length}</span>
            </div>
        </div>
    </div>);
}
